...
const Menubar = ({ activeMenu }) => {
    ...
    return (
        <div className="flex items-center justify-between gap-5 bg-white border border-b border-gray-200/50 backdop-blur-[2px] py-4 px-4 sm:px-7 sticky top-0 z-20">
            ...
            <div className="relative" ref={dropdownRef}>
                <button
                    ...
                    <User className="text-puprle-500" />
                </button>
                        ...
                        <div className="px-4 py-3 border-b border-gray-100">
                            <div className="flex items-center gap-3">
                                <div className="flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full">
                                    <User className="2-4 h-4 text-purple-600" />
                                </div>
